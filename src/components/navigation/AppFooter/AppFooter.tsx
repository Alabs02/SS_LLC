      ...
      <Fragment>
        {list.map((link, i) => (
          <li key={i} className="app-footer__list-item">
            <NavLink to={link.to} className="app-footer__link ft-13 fw-normal msb-8">
              {link.title}
            </NavLink>
          </li>
        ))}
          ...
          <div className="app-footer__content w-full">
            <div className="row">
              <div className="col-sm-12 col-md-5 msb-24 msb-md-0">
                <h6 className="app-footer__heading app-footer__heading--lg ft-22 fw-medium msb-8">SSAF Logistics</h6>

                <div className="app-footer__heading text-uppercase ft-14 fw-medium msb-4">Lagos Office</div>
                <p className="m-0 app-footer__text ft-13 fw-normal lh-20 msb-8">Suite D213, ogba Multipurpose Shopping Complex, Ikeja, Lagos.</p>

                <div className="app-footer__heading text-uppercase ft-14 fw-medium msb-4">Minnesota Office</div>
                <p className="m-0 app-footer__text ft-13 fw-normal lh-20 msb-8">3300 Country Road 10 Brooklyn Center MN55429, Suite 206.</p>

                <p className="m-0 app-footer__text ft-13 fw-normal lh-20">Tel: +(234)0913245 7112, +1(832)-970-2740</p>
                <p className="m-0 app-footer__text ft-13 fw-normal lh-20">info@ssafllc.com</p>
              </div>

              <div className="col-md-6 col-sm-12 d-flex align-items-start justify-content-between msb-24 msb-md-0">
                <div className="col-6">
                  <h6 className="app-footer__heading ft-15 fw-medium msb-4">Company</h6>
                ...
                <div className="col-6">
                  <h6 className="app-footer__heading ft-15 fw-medium">Services</h6>
                  <ul className="app-footer__list">
