        ...
        >
          ...
          <div className="search d-flex align-items-start msl-92 msr-92 mst-24">
            <input
              ...
              placeholder="Search for item model"
            />
            <button className="btn-white search__btn d-grid place-items-center ">
              <IoSearch />
            </button>
          </div>
          <div className="main__categories msl-92 msr-92">
            ...
            <div className="cards mst-8 d-flex gap-53 msb-36 f-wrap">
              <div className="btn btn-lg">
                <div className="head ft-16 fw-medium lh-24 app-text-dark mst-38 msb-38">
                  Home & Office
                </div>
              </div>
              <div className="btn btn-lg ">
