                ...
                <Modal.Cover
                    ...
                    <Modal.Content>
                        ...
                        <div className="flex justify-content-center mst-37 msb-48">
                            <button type="button" className="btn btn-tonic-light btn-md msr-13">View Shipment List</button>
                            <button type="button" className="btn btn-tonic btn-md">Proceed To Add Items</button>
                        </div>
                    </Modal.Content>
                </Modal.Cover>
            </Modal>
