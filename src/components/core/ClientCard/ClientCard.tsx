        ...
        <div className="client-card ps-20">
          <div className="client-card__body">
            ...
            <div className="client-card__content">
              <div className="client-card__heading ft-18 lh-26 fw-normal">John Deo</div>
              <div className="client-card__subheading ft-15 lh-22 fw-normal mst-8">000, XYZ Street, Ikeja, Lagos, Nigeria</div>
            </div>
          </div>
