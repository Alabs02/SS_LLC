...
const EditRecipient = () => {
  ...
  const breadcrumbItems = [
    ...
    {
      to: "/recipients/edit",
      title: "Edit Recipient's Details"
    },
  ];
        ...
        <form className="form msl-24 msr-24 msb-24 mst-0">
          <div className="grid grid-col-12 gap-x-48 w-full">
            <div className="col-span-12 col-span-md-6 gap-x-46 msb-24">
              <label htmlFor="recipient__name" className="form-label ms-0 msb-8 fw-normal ft-13 lh-20 ">Name</label>
              <input
              type="text"
            ...
            <div className="col-span-12 col-span-md-6 msb-24">
              <label htmlFor="recipient__country" className="form-label ms-0 msb-8 fw-normal ft-13 lh-20">Country/Territory</label>
              <select name="recipient__country" id="country" className="w-100 app-form-control">
            ...
            <div className="col-span-12 col-span-md-6 gap-x-48 msb-24">
              <div className="recipient__address">
                <label htmlFor="recipient__address" className="form-label ms-0 msb-8 fw-normal ft-13 lh-20">Address</label>
                <input
                type="text"
            ...
            <div className="col-span-12 col-span-md-3 gap-x-48 msb-24">
              <div className="recipient__city">
                <label htmlFor="recipient__city" className="form-label ms-0 msb-8 fw-normal ft-13 lh-20">City</label>
                <input
                type="text"
            ...
            <div className="col-span-12 col-span-md-3 msb-24">
              <div className="recipient__state">
                <label htmlFor="recipient__state" className="form-label ms-0 msb-8 fw-normal ft-13 lh-20">State</label>
                <input
                type="text"
            ...
            <div className="col-span-12 col-span-md-6 msb-24 gap-x-48">
              <div className="recipient__email">
                <label htmlFor="recipient__email" className="form-label ms-0 msb-8 fw-normal ft-13 lh-20">Email Address</label>
                <input
                type="email"
            ...
            <div className="col-span-12 col-span-md-6 msb-24">
              <label htmlFor="recipient__phone" className="form-label ms-0 msb-8 fw-normal ft-13 lh-20">Phone</label>
