        ...
        <Fragment>
            ...
            <div className="card mst-48 border-0 round-0 msb-50">
                ...
                <div className="grid grid-col-12 gap-x-48 w-full">
                    ...
                    className="form-label ms-0 msb-8 fw-normal ft-13 lh-20">Dimensions (cm)</label>
                    <input 
                    type="number" 
                    ...
                    <div className="col-span-12 col-span-md-3 msb-24">
                        ...
                        className="form-label ms-0 msb-8 fw-normal ft-13 lh-20">Gross Weight (kg)</label>
                        <input 
                        type="number" 
                        name="gross__weight" 
                        className="app-form-control round-0 h-40" />
                    ...
                    <div className="col-span-12 col-span-md-3 msb-24">
                        ...
                        className="form-label ms-0 msb-8 fw-normal ft-13 lh-20">Delivery Option</label>
                        <select name="delivery__option"  className="w-100 app-form-control">
                    ...
                    <div className="col-span-12 col-span-md-6 msb-24">
                        ...
                        className="form-label ms-0 msb-8 fw-normal ft-13 lh-20">Source Office</label>
                        <select name="source__office"  className="w-100 app-form-control">
                    ...
                    <div className="col-span-12 col-span-md-6 msb-24">
                        ...
                        className="form-label ms-0 msb-8 fw-normal ft-13 lh-20">Destination Office</label>
                        <select name="destination__office"  className="w-100 app-form-control">
            ...
            <div className="card mst-48 border-0 round-0 msb-24 app-text-tonic">
                ...
                <div className="warning__text mst-8 msl-27 msb-18 fw-normal ft-16 lh-22">
                    Note that all shipment items will be dropped off at the chosen source office.
                </div>
            </div>
